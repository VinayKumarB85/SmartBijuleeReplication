...
const Informationcards = ({ height, logo , name , loginId}) => {
  ...
  return (
    <View style={[flex(1), { width: widthValue(1.1) }, styles.positionRelative, marginPosition(30)]}>
      <View style={[styles.allCenter, { height: heightValue(height) }, styles.bgdashblue, marginPosition(0, 0, 10), radius(20)]}>
        <TouchableOpacity onPress={handlealert} style={[styles.allCenter, marginPosition(0, 0, 20)]}>
          {show ? (
        ...
        <Text style={[styles.white, fontSize(19), marginPosition(10)]}>{name}</Text>
        <View style={[styles.row]}>
