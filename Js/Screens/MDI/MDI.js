        ...
        <DrawerScreenWrapper>
            <SafeAreaView style={[flex(1), { width: widthValue(1), },  darkmode?styles.bglightblack:styles.bgLightWhite,]}>
                ...
                <ScrollView >
                    ...
                    <View style={[marginPosition(15, 20, 0, 20), darkmode?styles.bgbarback:styles.bgWhite, radius(18), screenHeight(1.9), padding(0, 20, 10)
                    ]}>
                        <View style={[styles.row, paddingPosition(0, 0, 20, 10)]}>
                            <Text style={[darkmode?styles.fontwhite:styles.black, fontSize(22)]}>Monthly</Text>
                            <Text style={[styles.green, fontSize(22)]}> Max Demand</Text>
                        </View>
                        <Graphsheet data={graphData.monthData} xValue={'month'} yValue={'bill'} />
                        <View style={[styles.centerHorizontal, { gap: 5 },marginPosition(-10)]}>
                            <Text style={[darkmode?styles.fontwhite:styles.black, fontSize(11)]}>(Click on the chart to see the value) </Text>
                    ...
                    <View style={[marginPosition(20, 20, 30, 20),darkmode? styles.bgbarback:styles.bgWhite, radius(18), screenHeight(5.8), padding(0, 20, 10)]}>
                        <View style={[styles.row, paddingPosition(0, 0, 15, 10)]}>
                            <Text style={[darkmode?styles.fontwhite:styles.black, fontSize(20)]}>Recorded </Text>
                        ...
                        <View style={[styles.row, styles.spaceBetweenVertical, marginPosition(0, 20, 10, 20), paddingPosition(0, 0, 10, 0), borderWidth(0, 0, 0, .8, 0), styles.borderGray]}>
                            <Text style={[darkmode?styles.fontwhite:styles.black, fontSize(15)]}>Log Date</Text>
                            <Text style={[darkmode?styles.fontwhite:styles.black, fontSize(15)]}>P-MD</Text>
                            <Text style={[darkmode?styles.fontwhite:styles.black, fontSize(15)]}>A-MD</Text>
                            <Text style={[darkmode?styles.fontwhite:styles.black, fontSize(15)]}>voltage</Text>
                        </View>
