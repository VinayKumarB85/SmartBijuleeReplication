...
const PersonalInfo = () => {
  ...
  return (
    <SafeAreaView style={[styles.bglightblack,flex(1),padding(0,20,30)]}>
      <BackButton />
      <View style={[styles.bggreenish,{width:widthValue(9),height:widthValue(9)},radius(widthValue(4.5)),styles.allCenter,styles.positionAbsolute,{top:heightValue(10),zIndex:99,left:widthValue(1.8)}]}>
        <FontAwesome5 name='camera' style={[fontSize(15),styles.fontwhite]} />
      </View>
    ...
    <View style={[styles.bgbarback,{width:widthValue(1.12),height:heightValue(4.7),},radius(20),styles.centerHorizontal]}>
        <View style={[marginPosition(-40),styles.centerHorizontal]}>
          ...
          <View style={[styles.centerHorizontal,marginPosition(5)]}>
            <Text style={[styles.fontwhite,fontSize(15)]}>JuliusCeaser</Text>
            <Text style={[styles.green,fontSize(11)]}>Consumer ID:C000003</Text>
          </View>
        </View>
    </View>
