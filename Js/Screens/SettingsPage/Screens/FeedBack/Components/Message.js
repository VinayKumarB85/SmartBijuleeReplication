      ...
      <View style={[styles.centerHorizontal,]}>
          ...
          <View style={[{ width: widthValue(1.16), height: heightValue(2.8),zIndex:99 }, styles.bgbarback, marginPosition(0,0,0,0), radius(0, 15, 30, 30, 15), styles.spaceAroundVertical]}>
            ...
            <View style={[styles.centerHorizontal,marginPosition(0,30,0,30),{marginTop:10},flex(1)]}>
              <TextInput  placeholder={'write your feedback in less than 200 words' } style={[,{width:widthValue(1.4),height:heightValue(5),paddingVertical:5,textAlignVertical:'top'},styles.bgWhite,radius(15)]}/>
            </View>
            </View>
          </View>
          ...
          {/* <TouchableOpacity onPress={handleNextPress} style={[{ backgroundColor: getButtonColor() }, radius(30),padding(0,10, 30),  styles.allCenter,styles.rowReverse,{gap:20}]}>
