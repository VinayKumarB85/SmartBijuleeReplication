  ...
  return (
    <View style={[{width:widthValue(1.15),},marginPosition(0,25,0,25),styles.bgbarback,padding(0,20,20),radius(15)]}>
      ...
      <View style={[borderWidth(0,1,0,0,0),styles.borderGreen,paddingPosition(20,20,0,20),{height:heightValue(3.5)}]}>
        ...
        <TextInput maxLength={200} placeholderTextColor={'black'} placeholder='Hey ,the app is fabulous.. Especially the design' multiline={true}  style={[ {height:heightValue(4.5)},padding(0,10,20), fontSize(10),radius(15),styles.bgWhite]} inputStyle={[{ textAlignVertical: 'top' }]} />
      </View>
    </View>
  )
}
